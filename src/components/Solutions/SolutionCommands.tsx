  ...
  return (
    <div>
      <div className="pt-2 w-fit">
        <div className="text-xs text-white/90 backdrop-blur-md /60 rounded-lg py-2 px-4 flex items-center justify-center gap-4" style={{backgroundColor: `rgba(0, 0, 0, var(--stealth-opacity, 0.95))`}}>
          {/* Show/Hide */}
          ...
          >
            ...
            {isTooltipVisible && (
              <div
                ...
                style={{ zIndex: 100 }}
              >
                <div className="p-3 text-xs /80 backdrop-blur-md rounded-lg border border-white/10 text-white/90 shadow-lg" style={{backgroundColor: `rgba(0, 0, 0, var(--stealth-opacity, 0.95))`}}>
                  {/* Tooltip content */}
